...
label3.caption:='Equilibrando todos los ítems sobre 100...';
...
if riskchart.res>24 then riskchart.res:=riskchart.res+43;
if riskchart.cog>24 then riskchart.cog:=riskchart.cog+43;
label3.caption:='Equilibrando los 3 ítems más altos...';
 label3.visible:=true; label3.refresh;
{
The Great Invocation
...
if riskchart.res>24 then riskchart.res:=riskchart.res+43;
if riskchart.cog>24 then riskchart.cog:=riskchart.cog+43;
label3.caption:='Equilibrando todos los ítems inferiores a 60...';
 label3.visible:=true; label3.refresh;
{
The Great Invocation
...
if riskchart.res>24 then riskchart.res:=riskchart.res+43;
if riskchart.cog>24 then riskchart.cog:=riskchart.cog+43;
label3.caption:='Equilibrando ítems altos y bajos...';
 label3.visible:=true; label3.refresh;
{
The Great Invocation
...
if riskchart.res>24 then riskchart.res:=riskchart.res+43;
if riskchart.cog>24 then riskchart.cog:=riskchart.cog+43;
label3.caption:='Equilibrando todos los 3 ítems más bajos...';
 label3.visible:=true; label3.refresh;
{
The Great Invocation
